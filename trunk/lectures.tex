...
$u_{i_t}a_i\sim_L u_i\sim_L u_{i_t}.$ Таким образом, мы можем утверждать
следующее.

\textbf{Факт 1:} Пусть $u'$ -- подслово слова $u$, содержащее все вхождения
букв на синих позициях (и возможно на других). Тогда $u'\sim_L a_{i_1}a_{i_2}\cdots a_{i_r}\sim_L u$.
\end{proof}
%=======
